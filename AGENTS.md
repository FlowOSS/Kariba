...
- PLAN.md "Known Issues / Follow-ups" lists accepted bugs (orphaned scans on client disconnect, `scan.cancel` unimplemented, DB mutex held for whole scan). Check there before diagnosing scan behavior as new.
